...
export class ReadingWatcherPage {
  ...
  private _readingState = [
    {
      ...
      states: [
        ...
        {
          order: 251,
          text: "Our soft dimension for death is to fear others agreeable."
        },
        {
          order: 352,
          text: "A playful form of ascension is the manifestation."
        },
    ...
    },
    {
      ...
      states: [
        ...
        {
          order: 515,
          text: "In wonderland PLURALdisturb harmoniously density."
        }
      ]
    }
  ];
  ...
  __discuss = [
    ...
    },
    {
      ...
      book: "I Do Not Know !",
      lastText:
        "Incididunt Lorem pariatur cillum aliqua reprehenderit commodo duis nulla cupidatat aliquip esse."
    },
    {
      reader: "Maria Linoti",
      book: "I am Feeling",
      lastText:
        "Ex dolore quis nisi aliqua cillum tempor do ex qui cillum enim fugiat."
    },
    {
      reader: "Tempor Fugiat",
      book: "Eiusmod occaecat sunt magna.",
      lastText:
        "Amet reprehenderit amet laborum commodo reprehenderit culpa qui veniam velit nostrud proident consectetur cupidatat."
    },
    {
      reader: "Ex Sunt Pariatur",
      book: "Culpa do elit voluptate.",
      lastText:
        "Consectetur proident qui nulla minim ullamco amet ut voluptate nulla est nostrud officia aliqua."
    }
  ];
